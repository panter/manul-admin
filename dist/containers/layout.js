...
var mainLayoutMapper = exports.mainLayoutMapper = function mainLayoutMapper(context) {
  return (0, _get3.default)('adminContext.components.views.MainLayout'.split('.'), context);
};
...
exports.default = (0, _mantraCore.composeAll)((0, _mantraCore.composeWithTracker)(composer), (0, _restrict_to_roles2.default)('admin', NotAllowedWrapper), (0, _mantraCore.useDeps)(depsMapper))((0, _component_from_context_or2.default)('views.layout', _admin_layout2.default));
