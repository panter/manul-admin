...
var getPipeline = function getPipeline(_ref) {
  ...
  var aggregationOptions = aggregation && (0, _isFunction2.default)(aggregation) ? aggregation({ collectionConfig: collectionConfig, listOptions: listOptions, countOnly: countOnly }) : aggregation;
  ...
  var sortPipeline = [].concat((0, _toConsumableArray3.default)(!(0, _isEmpty2.default)(queryOptions.sort) ? [{ $sort: queryOptions.sort }] : []), [{ $limit: queryOptions.limit + queryOptions.skip }, { $skip: queryOptions.skip }]);
